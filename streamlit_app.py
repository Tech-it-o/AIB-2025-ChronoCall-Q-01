...
def main():
    ...
    with st.expander("1️⃣ การเพิ่มเหตุการณ์ (Add Event)"):
        st.markdown("""
    ...
    with st.expander("2️⃣ การลบเหตุการณ์ (Delete Event)"):
        st.markdown("""
    เพื่อทำการลบเหตุการณ์ ต้องระบุ:
    - **ชื่อเหตุการณ์**
    - **วันที่**

    ตัวอย่าง: `"ลบนัดประชุมพรุ่งนี้"`
    """)

    with st.expander("3️⃣ การอัปเดตเหตุการณ์ (Update Event)"):
        st.markdown("""
    ...
    with st.expander("4️⃣ การดูเหตุการณ์ (View Events)"):
        st.markdown("""
